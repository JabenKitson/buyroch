...
def initialize(uid,pwd)
 ...
 def login
  ...
  def addsale(p)
   ...
   @form['ForSaleAskingPriceTextBox1'] = p.price
   @form['PropertyNameTextBox1'] = p.title
   @form['PropertyAddressTextBox1'] = p.address
   @form['PropertyCityTextBox1'] = 'Rochester'
   @form['lPropertyPostalCodeTextBox1'] = '55901'
   @form['PropertyDescriptionTextBox1'] = p.description
